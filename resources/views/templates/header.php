...
<head>
    ...
    <title><?php echo ( $title ); ?> | InteraApps.de</title>
    <script>window.document.title = '<?php echo ( $title ); ?> | InteraApps.de';</script>
    <!-- Fonts -->
...
<body>
    ...
    <div id="menu">
        <div id="menu_links">
        <a closenav hrefnrl="" href="/"><?php echo ( ulole\core\classes\Lang::lang("menu_home") ); ?></a>
        <a closenav hrefnrl="" href="/about"><?php echo ( ulole\core\classes\Lang::lang("menu_about") ); ?></a>
