...
<div id="homepagetopsection">
    <div id="homepagetopsectioninner">
        <a id="homepagetopslogan">{{ $pagetitle }}</a>
    </div>
</div>
<br><br><br>
<div class="lightsection">
    <div id="githubpagesection">
        <div id="sidenav">
            <div id="reposowner">
                <img src="{{$repos->owner->avatar_url}}" width="100px">
                <a id="username" class="link_black" href="{{$repos->owner->html_url}}">{{$repos->owner->login}}</a>
            </div><br><br>
            <span class="entry">Owner: <a href="{{$repos->owner->html_url}}" class="link_black">{{$repos->owner->login}}</a></span><br>
            <span class="entry">GitHub Link: <a href="{{$repos->html_url}}" class="link_black">GitHub</a></span><br>
            <span class="entry">Description: {{$repos->description}}</span><br>
        </div>
        <div id="readme">
            {{$readme}}
        </div>
